package fr.inti.store.repository;

import fr.inti.store.StoreApp;
import fr.inti.store.config.Constants;
import fr.inti.store.config.audit.AuditEventConverter;
import fr.inti.store.domain.PersistentAuditEvent;
...
import static fr.inti.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
